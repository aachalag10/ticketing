...
ALLOWED_HOSTS = []  # Use ['*'] for local network testing
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # If using global template dir
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / 'booking' / 'static',  # You had this line twice, kept it in case needed
]
